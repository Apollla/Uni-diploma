        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full text-white">
          ...
          <div>
            ...
            <p className="mt-4 text-white/80 text-lg max-w-md leading-relaxed">
              Welcome back. Continue managing your organization resources with clarity and control.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-white/80 text-sm">
                Real-time insights into your resources.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/80 text-sm">
                Fast dashboards and instant decisions.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/80 text-sm">
                Safe and role-based access system.
              </p>
            </div>
          </div>
